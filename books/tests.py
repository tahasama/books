...
class BookTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username='reviewuser',email='reviewuser@email.com',password='testpass123')
    ...
    def test_book_listing(self):
        ...
        self.assertEqual(f'{self.review.author.username}', 'reviewuser')
        # test all the fields ==> all the possibility
